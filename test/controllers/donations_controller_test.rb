...
class DonationsControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create donation" do
    assert_difference('Donation.count') do
      post donations_url, params: { donation: { address: @donation.address, amount: @donation.amount, name: @donation.name, phone: @donation.phone, receipt_no: @donation.receipt_no } }
    end
  ...
  test "should update donation" do
    patch donation_url(@donation), params: { donation: { address: @donation.address, amount: @donation.amount, name: @donation.name, phone: @donation.phone, receipt_no: @donation.receipt_no } }
